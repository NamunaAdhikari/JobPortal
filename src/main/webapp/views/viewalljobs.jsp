...
<%@ page import="com.namuna.JobApp.model.JobPost" %>
<%@ page import="com.namuna.JobApp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">NaMa Job Portal Web App</a>
